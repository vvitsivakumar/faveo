...
.url:hover
{
  ...
  <body>
	<div id="content">
		...
		<p class="expl">Generated by <a href="" target="_blank" title="Sitemap generator for Laravel">laravel-sitemap</a>. This is styled version xml sitemap (for Google News), sorted by update date.</p>
