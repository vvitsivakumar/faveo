            ...
            const n = {},
                o = (e, n) => new Promise(((o, r) => {
                    ...
                    s.open("POST", t.url), s.withCredentials = t.credentials, s.upload.onprogress = e => {
                        ...
                        if (s.status === 400) return void r(JSON.parse(s.responseText).message);
                        const e = JSON.parse(s.responseText);
                        var n, a;
                        e && m(e.location) ? o((n = t.basePath, a = e.location, n ? n.replace(/\/$/, "") + "/" + a.replace(/^\//, "") : a)) : r(JSON.parse(s.responseText).message.file)
                    };
