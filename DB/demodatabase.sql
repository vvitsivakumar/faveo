...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 03, 2018 at 01:01 PM
...
CREATE TABLE IF NOT EXISTS `approval_level_approvers` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `approval_level_statuses` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `approval_level_id` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `approval_workflow_tickets` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `approval_workflow_id` int(10) UNSIGNED NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `approver_statuses` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
(1, 'Default Business-Hours', 'default', 1, 'Asia/Kolkata', '2017-03-29 05:23:24', '2018-03-29 02:02:43', 0);
...
(18, 'dashboard-statistics', 'departments,agents,teams', '', '', '2017-12-27 13:35:14', '2017-12-27 13:35:14'),
(19, 'helptopic_link_with_type', '', '1', '', '2018-02-05 06:41:09', '2018-02-05 13:17:17'),
(20, 'allow_external_login', '', '0', '', '2018-02-05 06:41:09', '2018-02-05 06:41:09'),
(21, 'allow_users_to_access_system_url', '', '0', '', '2018-02-05 06:41:09', '2018-02-05 06:41:09'),
(22, 'redirect_unauthenticated_users_to', '', '', '', '2018-02-05 06:41:09', '2018-02-05 06:41:09'),
(23, 'redirect_unauthenticated_users_to', '', '', '', '2018-03-29 02:37:42', '2018-03-29 02:37:42'),
(24, 'validate_token_api', '', '', '', '2018-03-29 02:37:42', '2018-03-29 02:37:42'),
(25, 'validate_api_parameter', 'token', '', '', '2018-03-29 02:37:42', '2018-03-29 02:37:42'),
(27, 'batch_tickets', '', '0', '', '2018-03-29 02:37:42', '2018-03-29 02:37:42'),
(28, 'redirect_to_timeline', '', '0', '', '2018-03-29 02:37:42', '2018-03-29 02:37:42'),
(29, 'allow_organization_mngr_approve_tickets', '', '0', '', '2018-05-02 00:57:03', '2018-05-03 00:31:51'),
(30, 'allow_organization_dept_mngr_approve_tickets', '', '0', '', '2018-05-02 00:57:03', '2018-05-03 00:31:51'),
(31, 'show_gravatar_image', '', '1', '', '2018-08-20 00:00:07', '2018-08-20 00:00:07'),
(32, 'time_track', '', '0', '', '2018-08-20 00:00:07', '2018-09-04 05:36:32');
...
INSERT INTO `conditions` (`id`, `job`, `value`, `created_at`, `updated_at`, `icon`, `command`, `job_info`, `active`, `plugin_job`, `plugin_name`) VALUES
(1, 'fetching', 'everyTenMinutes', '2017-03-29 05:23:27', '2018-10-27 05:38:55', 'fa fa-arrow-circle-o-down', 'ticket:fetch', 'fetching-info', 1, 0, NULL),
(2, 'notification', 'everyTenMinutes', '2017-03-29 05:23:27', '2018-10-27 05:38:55', 'fa fa-line-chart', 'report:send', 'notification-info', 1, 0, NULL),
(3, 'work', 'everyTenMinutes', '2017-03-29 05:23:27', '2018-10-27 05:38:55', 'fa fa-archive', 'ticket:close', 'work-info', 1, 0, NULL),
(4, 'followup', 'everyTenMinutes', '2017-03-29 05:23:27', '2018-10-27 05:38:55', 'fa fa-history', 'users:followup', 'followup-info', 1, 0, NULL),
(5, 'escalation', 'everyTenMinutes', '2018-10-27 05:38:55', '2018-10-27 05:38:55', 'fa fa-hourglass-half', 'send:escalation', 'escalation-info', 1, 0, NULL),
(6, 'recur', 'daily', '2018-10-27 05:38:55', '2018-10-27 05:38:55', 'fa  fa-repeat', 'ticket:recur', 'recur-info', 1, 0, NULL),
(7, 'check-updates', 'daily', '2018-10-27 05:38:55', '2018-10-27 05:38:55', 'fa fa-refresh', 'faveo:checkupdate', 'check-updates-info', 1, 0, NULL);
...
INSERT INTO `department` (`id`, `name`, `type`, `manager`, `ticket_assignment`, `outgoing_email`, `template_set`, `auto_ticket_response`, `auto_message_response`, `auto_response_email`, `recipient`, `group_access`, `department_sign`, `created_at`, `updated_at`, `business_hour`, `nodes`, `en_auto_assign`) VALUES
(1, 'Support', '1', 6, '', '', '', '', '', '', '', '', '', '2017-03-29 05:23:25', '2017-03-30 03:06:18', 0, NULL, 0),
(2, 'Sales', '1', 4, '', '', '', '', '', '', '', '', '', '2017-03-29 05:23:25', '2017-03-30 03:06:09', 0, NULL, 0),
(3, 'Operation', '1', 7, '', '', '', '', '', '', '', '', '', '2017-03-29 05:23:25', '2017-03-30 03:05:50', 0, NULL, 0);
...
CREATE TABLE IF NOT EXISTS `emails` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `block_auto_generated` tinyint(4) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `kb_article` (
  ...
  `visible_to` varchar(255) COLLATE utf8_unicode_ci DEFAULT 'all_users',
...
INSERT INTO `kb_settings` (`id`, `pagination`, `created_at`, `updated_at`, `status`, `date_format`) VALUES
(1, 10, '2017-03-29 05:23:25', '2017-03-29 05:23:25', 1, 'MMMM Do YYYY, h:mm:ss a');
...
(235, '2018_09_03_054808_create_ticket_filters_table', 1),
(236, '2018_09_03_113219_create_ticket_filter_metas_table', 1),
(237, '2018_09_03_115529_create_ticket_filter_shareables_table', 1),
(238, '2018_09_05_104247_add_session_timeout_duration_to_settings_security', 7),
(239, '2018_09_20_071459_create_approval_workflows_table', 7),
(240, '2018_09_20_072143_create_approval_levels_table', 7),
(241, '2018_09_20_073404_create_approval_level_approvers_table', 7),
(242, '2018_10_09_021450_create_approval_workflow_tickets_table', 7),
(243, '2018_10_09_021533_create_approval_level_statuses_table', 7),
(244, '2018_10_09_021548_create_approver_statuses_table', 7),
(245, '2018_10_09_110747_create_user_types_table', 7),
(246, '2018_10_16_084837_add_new_columns_to_conditions_table', 7),
(247, '2018_10_18_005529_add_comment_to_approver_statuses_table', 7),
(248, '2018_10_19_132628_add_status_columns_to_approval_workflows_table', 7),
(249, '2018_10_24_025346_add_status_columns_to_approval_workflow_tickets_table', 7),
(250, '2018_10_25_113734_alter_tickets_table_add_column_last_estd_duedate', 7),
(251, '2018_10_31_123651_alter_table_reports', 7),
(252, '2018_11_21_115351_add_rating_icon_in_ratings_table', 7),
(253, '2018_11_26_062439_create_attachments_table', 8),
(254, '2018_11_26_062543_create_linked_attachments_table', 8),
(255, '2018_11_27_110014_alter_user_table_phone_number', 8),
(256, '2018_11_27_122807_add_version_to_plugins_table', 8),
(257, '2018_09_03_054808_create_ticket_filters_table', 1),
(258, '2018_09_03_113219_create_ticket_filter_metas_table', 1),
(259, '2018_09_03_115529_create_ticket_filter_shareables_table', 1);
...
CREATE TABLE IF NOT EXISTS `organization_dept` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `org_dept_manager` text COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(17, 1, '{\"create_ticket\":\"1\",\"edit_ticket\":\"1\",\"close_ticket\":\"1\",\"transfer_ticket\":\"1\",\"delete_ticket\":\"1\",\"assign_ticket\":\"1\",\"access_kb\":\"1\",\"ban_email\":\"1\",\"organisation_document_upload\":\"1\",\"email_verification\":\"1\",\"mobile_verification\":\"1\",\"account_activate\":\"1\"}', '2018-02-19 12:56:32', '2018-02-19 12:56:32'),
(18, 1, '{\"create_ticket\":\"1\",\"edit_ticket\":\"1\",\"close_ticket\":\"1\",\"transfer_ticket\":\"1\",\"delete_ticket\":\"1\",\"assign_ticket\":\"1\",\"access_kb\":\"1\",\"ban_email\":\"1\",\"organisation_document_upload\":\"1\",\"email_verification\":\"1\",\"mobile_verification\":\"1\",\"account_activate\":\"1\"}', '2018-03-29 02:02:43', '2018-03-29 02:02:43');
...
INSERT INTO `ratings` (`id`, `name`, `display_order`, `allow_modification`, `rating_scale`, `rating_area`, `restrict`, `rating_icon`, `created_at`, `updated_at`) VALUES
(1, 'OverAll Satisfaction', 1, 1, 5, 'Helpdesk Area', '', 'star', '2017-03-29 05:23:27', '2017-03-29 05:23:27'),
(2, 'Reply Rating', 1, 1, 5, 'Comment Area', '', NULL, '2017-03-29 05:23:27', '2017-03-29 05:23:27');
...
CREATE TABLE IF NOT EXISTS `reports` (
  ...
  `ext` char(5) COLLATE utf8_unicode_ci NOT NULL,
...
(1, 1, '', 'CHAMPPS', '1', '', '', '', 0, 0, '', '', NULL, NULL, 'Europe/London', 'F j, Y, g:i a', '', 'en', 'v1.9.47', '2017-03-29 05:23:25', '2018-07-04 08:46:33', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `settings_ticket` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `count_internal` tinyint(4) NOT NULL DEFAULT '0',
  `show_status_date` tinyint(4) NOT NULL DEFAULT '0',
  `show_org_details` tinyint(4) NOT NULL DEFAULT '0',
  `custom_field_name` text COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `settings_ticket` (`id`, `num_format`, `num_sequence`, `help_topic`, `max_open_ticket`, `collision_avoid`, `lock_ticket_frequency`, `captcha`, `status`, `claim_response`, `assigned_ticket`, `answered_ticket`, `agent_mask`, `html`, `client_update`, `max_file_size`, `created_at`, `updated_at`, `count_internal`, `show_status_date`, `show_org_details`, `custom_field_name`) VALUES
(1, '$$$$-####-####', 'sequence', '1', '', '2', '0', '', 1, 0, 0, 0, 0, 0, 0, 0, '2017-03-29 05:23:25', '2017-03-29 05:23:25', 0, 0, 0, NULL);
...
CREATE TABLE IF NOT EXISTS `sla_custom_enforcements` (
  ...
  `f_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `f_value` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `f_label` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
(3, 'template-new-password', '1', 15, 'Password changed', 'Hello {!! $receiver_name !!},<br /><br />Your password is successfully changed.Your new password is : {!! $user_password !!}<br /><br />Thank You.<br /><br />Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'common-tmeplates'),
...
(9, 'template-ticket-assignment-notice-to-client', '0', 1, '', 'Hello {!! $receiver_name !!},<br /><br />Your ticket with ID: {!! $ticket_number !!} has been assigned to one of our agents. They will contact you soon.<br /><br /><br />Kind Regards,<br />{!! $system_from !!}</p>', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'client-templates'),
(10, 'template-ticket-reply-to-client-by-agent', '0', 9, '', '{!! $message_content !!}<br /><br /><strong>Ticket Details</strong><strong>Ticket ID:</strong> {!! $ticket_number !!}<br /><br />{!! $agent_signature !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'client-templates'),
(11, 'template-ticket-assigment-notice-to-team-client', '1', 14, '', '<p>Hello {!! $receiver_name !!},<br /><br />Your ticket with ID: {!! $ticket_number !!} has been assigned to our {!! $assigned_team_name !!} team. They will contact you soon.<br /><br /><br />Kind Regards,<br />{!! $system_from !!}</p>', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'client-templates'),
(12, 'template-ticket-assignment-notice-to-assigned-agent', '0', 1, '', '<p>Hello {!! $receiver_name !!},<br /><br /><strong>Ticket No:</strong> {!! $ticket_number !!}<br />Has been assigned to you by {!! $activity_by !!}<br /><br />Thank You<br />Kind Regards,<br />{!! $system_from !!}</p>', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'assigend-agent-templates'),
(13, 'template-ticket-reply-to-assigned-agents-by-client', '0', 10, '', 'Hello {!! $receiver_name !!},<br /><br />Client has made a new reply on their ticket which is assigned to you.<br /><br /><strong>Ticket ID:</strong>  {!! $ticket_number !!}<br /><strong>Reply Message</strong><br />{!! $message_content !!}<br /><br />Please follow the link below to check and reply on ticket.<br />{!! $ticket_link !!}<br /><br />Thanks<br />{!! $system_from !!}<br />', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'assigend-agent-templates'),
(14, 'template-response-voilate-escalation-to-assigned-agent', '1', 12, 'Response Time SLA Violate', 'Hello {!! $receiver_name !!},<br /><br />There has been no response for a ticket assigned to you. The first response was due by {!! $ticket_due_date !!}.<br /><br />Ticket Details:<br />Subject: {!! $ticket_subject !!}<br />Number: {!! $ticket_number !!}<br />Requester: {!! $client_name !!}<br /><br />This is an automatic escalation email from {!! $system_from !!}<br /><br />Respond to ticket here {!! $ticket_link !!}<br /><br />Thank You.<br />Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'assigend-agent-templates'),
(15, 'template-resolve-voilate-escalation-to-assigned-agent', '1', 13, 'Resolve Time SLA Violate', 'Hello {!! $receiver_name !!},<br /><br />Ticket which is assigened to you has not been resolved within the SLA time period. The ticket was due by {!! $ticket_due_date !!}.<br /><br />Ticket Details:<br />Subject: {!! $ticket_subject !!}<br />Number: {!! $ticket_number !!}<br />Requester: {!! $client_name !!}<br /><br />This is an automatic escalation email from {!! $system_from !!}<br /><br />Respond to ticket here {!! $ticket_link !!}<br /><br />Thank You.<br />Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'assigend-agent-templates'),
(16, 'template-internal-change-to-assigned-agent', '1', 16, '', 'Hello {!! $receiver_name !!},<br /><br />This message is regarding your ticket with ticket ID {!! $ticket_number !!}.<br />{!! $message_content !!}.<br />By {!! $activity_by !!}<br /><br />Thank you<br />Kind regards,<br />{!! $system_from !!}<br />', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'assigend-agent-templates'),
(17, 'template-response-time-approach-to-assigned-agents', '1', 17, 'Response Time SLA Approaching', 'Hello {!! $receiver_name !!},<br /><br />There has been no response for a ticket assigned to you. The first response should happen on or before {!! $ticket_due_date !!}.<br /><br />Ticket Details:<br />Subject: {!! $ticket_subject !!}<br />Number: {!! $ticket_number !!}<br />Requester: {!! $client_name !!}<br /><br />This is an automatic escalation email from {!! $system_from !!}<br /><br />Respond to ticket here {!! $ticket_link !!} <br /><br />Thank You.<br />Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'assigend-agent-templates'),
(18, 'template-resolve-time-approach-to-assigned-agents', '1', 18, 'Resolution Time SLA Approaching', 'Hello {!! $receiver_name !!},<br /><br />Ticket has not been resolved within the SLA time period. The ticket has to resolve on or before {!! $ticket_due_date !!}.<br /><br />Ticket Details:<br />Subject: {!! $ticket_subject !!}<br />Number: {!! $ticket_number !!}<br />Requester: {!! $client_name !!}<br /><br />This is an automatic escalation email from {!! $system_from !!}<br /><br />Respond to ticket here {!! $ticket_link !!} <br /><br />Thank You.<br />Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'assigend-agent-templates'),
(19, 'template-ticket-status-update-assign-agent', '1', 21, '', 'Hello {!! $receiver_name !!},<br /><br />This email is regarding ticket {!! $ticket_number !!} which is assigned to you.<br />{!! $message_content !!}<br />Thank You.<br/><br />Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'assigend-agent-templates'),
(20, 'template-ticket-reply-to-assigned-agents-by-agent', '0', 9, '', 'Hello {!! $receiver_name !!},<br /><br />A reply has been made to ticket assigned to you with ID: {!! $ticket_number !!} by {!! $activity_by !!} in our helpdesk system.<br /><strong>Reply content</strong><br />{!! $message_content !!}<br /><strong>Ticket link</strong><br />{!! $ticket_link !!}<br />{!! $agent_signature !!}<br />Thanks<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'assigend-agent-templates'),
(21, 'template-new-ticket-creation-notice-agents', '0', 5, '', 'Hello {!! $receiver_name !!},<br /><br />New ticket with ID: {!! $ticket_number !!} has been created in our helpdesk.<br /><br /><strong>Client Details</strong><br /><strong>Name:</strong> {!! $client_name !!}<br /><strong>E-mail:</strong> {!! $client_email !!}<br /><br /><strong>Message</strong><br />{!! $message_content !!}<br /><br />Kind Regards,<br />{!! $system_from !!}</p>', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'agent-templates'),
(22, 'template-ticket-reply-to-agents-by-client', '0', 10, '', 'Hello {!! $receiver_name !!},<br /><br />Client has made a new reply on their ticket in our helpdesk system.<br /><br /><strong>Ticket ID:</strong>  {!! $ticket_number !!}<br /><strong>Reply Message</strong><br />{!! $message_content !!}<br /><br />Please follow the link below to check and reply on ticket.<br />{!! $ticket_link !!}<br /><br />Thanks<br />{!! $system_from !!}<br />', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'agent-templates'),
(23, 'template-response-voilate-escalation-to-agent', '1', 12, 'Response Time SLA Violate', 'Hello {!! $receiver_name !!},<br /><br />There has been no response for a ticket. The first response was due by {!! $ticket_due_date !!}.<br /><br />Ticket Details:<br />Subject: {!! $ticket_subject !!}<br />Number: {!! $ticket_number !!}<br />Requester: {!! $client_name !!}<br /><br />This is an automatic escalation email from {!! $system_from !!}<br /><br />Respond to ticket here {!! $ticket_link !!}<br /><br />Thank You.<br />Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'agent-templates'),
(24, 'template-resolve-voilate-escalation-to-agent', '1', 13, 'Resolve Time SLA Violate', 'Hello {!! $receiver_name !!},<br /><br />Ticket has not been resolved within the SLA time period. The ticket was due by {!! $ticket_due_date !!}.<br /><br />Ticket Details:<br />Subject: {!! $ticket_subject !!}<br />Number: {!! $ticket_number !!}<br />Requester: {!! $client_name !!}<br /><br />This is an automatic escalation email from {!! $system_from !!}<br /><br />Respond to ticket here {!! $ticket_link !!}<br /><br />Thank You.<br />Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'agent-templates'),
(25, 'template-ticket-assigment-notice-to-team', '1', 14, '', '<p>Hello {!! $receiver_name !!},<br /><br /><strong>Ticket No:</strong> {!! $ticket_number !!}<br /><br />Has been assigned to your team <b>{!! $assigned_team_name !!}</b> by {!! $activity_by !!}<br /><br />Follow the link below to check and reply on the ticket.<br />{!! $ticket_link !!}<br /><br />Thank You<br />Kind Regards,<br />{!! $system_from !!}</p>', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'agent-templates'),
(26, 'template-internal-change-to-agent', '1', 16, '', 'Hello {!! $receiver_name !!},<br /><br />This message is regarding ticket with ticket ID {!! $ticket_number !!}.<br />{!! $message_content !!}.<br />By {!! $activity_by !!}<br /><br />Thank you<br />Kind regards,<br />{!! $system_from !!}<br />', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'agent-templates'),
(27, 'template-response-time-approach-to-agents', '1', 17, 'Response Time SLA Approaching', 'Hello {!! $receiver_name !!},<br /><br />There has been no response for a ticket. The first response should happen on or before {!! $ticket_due_date !!}.<br/><br />Ticket Details:<br />Subject: {!! $ticket_subject !!}<br />Number: {!! $ticket_number !!}<br />Requester: {!! $client_name !!}<br /><br />This is an automatic escalation email from {!! $system_from !!}<br /><br />Respond to ticket here {!! $ticket_link !!} <br /><br />Thank You.<br />Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'agent-templates'),
(28, 'template-resolve-time-approach-to-agents', '1', 18, 'Resolution Time SLA Approaching', 'Hello {!! $receiver_name !!},<br /><br />Ticket has not been resolved within the SLA time period. The ticket has to resolve on or before {!! $ticket_due_date !!}.<br /><br />Ticket Details:<br />Subject: {!! $ticket_subject !!}<br />Number: {!! $ticket_number !!}<br />Requester: {!! $client_name !!}<br /><br />This is an automatic escalation email from {!! $system_from !!}<br /><br />Respond to ticket here {!! $ticket_link !!} <br /><br />Thank You.<br />Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'agent-templates'),
(29, 'template-new-user-entry-notice', '1', 19, 'New user has created', 'Hello {!! $receiver_name !!},<br/><br/>A new user has been registered in our helpdesk system.<br/><br/><strong>User Details</strong><br/><strong>Name: </strong>{!! $new_user_name !!}<br/><strong>Email</strong><strong>:</strong> {!! $new_user_email !!}<br/><br/>You can check or update the user\'s complete profile by clicking the link below<br/>{!! $user_profile_link !!}<br/><br/>Thank You.<br /><br />Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'agent-templates'),
(30, 'template-non-assign-escalation-notice', '1', 20, 'Non Assign Ticket', '', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'agent-templates'),
(31, 'template-ticket-status-update-agent', '1', 21, '', 'Hello {!! $receiver_name !!},<br /><br />This email is regarding ticket {!! $ticket_number !!}.<br />{!! $message_content !!}<br />Thank You.<br/><br />Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'agent-templates'),
(32, 'template-ticket-assignment-notice-to-agent', '0', 1, '', 'Hello {!! $receiver_name !!},<br /><br /><strong>Ticket No:</strong> {!! $ticket_number !!}<br />Has been assigned to {!! $agent_name !!} by {!! $activity_by !!}<br /><br /><br />Thank You<br /><br />Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'agent-templates'),
(33, 'template-ticket-reply-to-agents-by-agent', '0', 9, '', 'Hello {!! $receiver_name !!},<br /><br />An agent has replied to ticket with ID: {!! $ticket_number !!} in our helpdesk system.<br /><br /><strong>Reply content</strong><br />{!! $message_content !!}<br /><strong>Ticket link</strong><br />{!! $ticket_link !!}<br />{!! $agent_signature !!}<br />Thanks.<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'agent-templates'),
(34, 'template-ticket-approve', '0', 22, '', 'Hello {!! $agent_name !!},<br /><br />An agent has applied for approval to ticket with ID: {!! $ticket_number !!} in our helpdesk system.<br /><br /><strong>Ticket link</strong><br />{!! $ticket_link !!}<br /><br /><strong>Approve link</strong><br />{!! $approve_url !!}<br /><strong>Deny link</strong><br />{!! $deny_url !!}<br /><br />Thanks.<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'agent-templates'),
(35, 'report-export', '1', 33, 'Helpdesk report available for download', '<p>Hello {!! $receiver_name !!},<br /><br />{!! $report_type !!} is successfully generated and ready for download.<br /><br /><strong>Download link</strong><br />{!! $report_link !!}<br /><br />***Please note this link will be expired in {!! $report_expiry !!}.<br /><br />Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'agent-templates'),
(36, 'invoice', '0', 23, '', 'Hello {!! $client_name !!},<br /><br />An invoice has generated for ticket with ID: {!! $ticket_number !!}.<br /><br /><strong>Ticket link</strong><br />{!! $ticket_link !!}<br /><br /><strong>Total time spend</strong><br />{!! $total_time !!} Hours<br /><br /><strong>Cost</strong><br />{!! $currency !!}{!! $cost !!}<br /><br /><strong>Billing Date</strong><br />{!! $bill_date !!}<br /><br />Thanks.<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'client-templates'),
(37, 'task-reminder', '1', 24, 'Task Alert', '<p>Hello {!! $receiver_name !!},<br /><br />Your task {!! $task_name !!} is due on {!! $task_end_date !!}. </p>Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'common-tmeplates'),
(38, 'task-created', '1', 25, 'Task created', '<p>Hello {!! $receiver_name !!},<br /><br />Your task {!! $task_name !!} has been created,  is due on {!! $task_end_date !!}. </p>Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'common-tmeplates'),
(39, 'task-update', '1', 26, 'Task Update', '<p>Hello {!! $receiver_name !!},<br /><br />Your task {!! $task_name !!} has been updated by {!! $updated_by !!}.</p>Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'common-tmeplates'),
(40, 'task-status', '1', 27, 'Task status update', '<p>Hello {!! $receiver_name !!},<br /><br />Your task {!! $task_name !!} status has been {!! $status !!}.</p>Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'common-tmeplates'),
(41, 'task-assigned', '1', 28, 'Task Assigned', '<p>Hello {!! $receiver_name !!},<br /><br />You have been assigned to task {!! $task_name !!} by {!! $created_by !!}  is due on {!! $task_end_date !!}.</p>Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'common-tmeplates'),
(42, 'task-deleted', '1', 29, 'Task Deleted', '<p>Hello {!! $receiver_name !!},<br /><br />Your task {!! $task_name !!} was deleted or removed by {!! $updated_by !!}.</p>Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'common-tmeplates'),
(43, 'task-assigned-owner', '1', 30, 'Task Assigned', '<p>Hello {!! $receiver_name !!},<br /><br />Your task {!! $task_name !!} has been assigned to {!! $agent_name !!} and  is due on {!! $task_end_date !!}.</p><br />Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'common-tmeplates'),
(44, 'rating', '1', 31, 'Rating', '<div><p><strong>Rating (overall rating)</strong></p><p><strong>How would you rate overall support for the ticket {!! $ticket_link !!}?</strong></p><p>&nbsp;</p><form action=\"{!! $ratingUrl !!}\" method=\"post\"><input name=\"_token\" type=\"hidden\" value=\"{!! $session_id !!}\" /> &nbsp;<input name=\"OverAll Satisfaction\" type=\"radio\" value=\"1\" /> Unsatisfactory<br /><br />&nbsp;<input name=\"OverAll Satisfaction\" type=\"radio\" value=\"2\" /> Fair<br /><br />&nbsp;<input name=\"OverAll Satisfaction\" type=\"radio\" value=\"3\" />&nbsp;Satisfactory<br /><br />&nbsp;<input name=\"OverAll Satisfaction\" type=\"radio\" value=\"4\" /> Good<br /><br />&nbsp;<input name=\"OverAll Satisfaction\" type=\"radio\" value=\"5\" /> Excellent<br /><br /><input type=\"submit\" value=\"SUBMIT\" />&nbsp;</form></div><br /><br />Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'common-tmeplates'),
(45, 'rating-confirmation', '1', 32, 'Rating Submitted', '<p>Hello {!! $receiver_name !!},<br /><br />Overall rating has been submitted for ticket {!! $ticket_link !!}<br /><br />Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'common-tmeplates'),
(46, 'template-ticket-creation-acknowledgement-org-mngr-by-client', '0', 4, '', '<p>Hello {!! $receiver_name !!},<br/><br/>A member of your organization has created a new ticket in our helpdesk system.</p><p><strong>Ticket ID:</strong>&nbsp; {!! $ticket_number !!}<br/><br/><strong>Member&#39;s Details</strong><br/><strong>Name:</strong>&nbsp; {!! $client_name !!}<br/><strong>E-mail:</strong> {!! $client_email !!}<br/><br/><strong>Message</strong><br/>{!! $message_content !!}<br/><br/>Kind Regards,<br />{!! $system_from !!}</p>', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'org-mngr-templates'),
(47, 'template-ticket-creation-acknowledgement-org-mngr-by-agent', '0', 6, '', '<p>Hello {!! $receiver_name !!},<br/><br/>Our agent has created a new ticket for a request of your organization&#39;s member.</p><p><strong>Ticket ID:</strong>&nbsp; {!! $ticket_number !!}<br/><br/><strong>Member&#39;s Details</strong><br/><strong>Name:</strong>&nbsp; {!! $client_name !!}<br/><strong>E-mail:</strong> {!! $client_email !!}<br/><br/><strong>Message</strong><br/>{!! $message_content !!}<br/><br/>Kind Regards,<br />{!! $system_from !!}</p>', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'org-mngr-templates'),
(48, 'template-ticket-reply-to-agents-by-client-to-org-mngr', '0', 9, '', '{!! $message_content !!}<br /><br /><strong>Ticket Details</strong><strong>Ticket ID:</strong> {!! $ticket_number !!}<br /><br />{!! $agent_signature !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'org-mngr-templates'),
(49, 'template-ticket-reply-to-client-by-agent-to-org-mngr', '0', 10, '', 'Hello {!! $receiver_name !!},<br /><br />Your organization member has made a new reply on their ticket in our helpdesk system.<br /><br /><strong>Ticket ID:</strong>  {!! $ticket_number !!}<br /><strong>Reply Message</strong><br />{!! $message_content !!}<br /><br />Please follow the link below to check and reply on ticket.<br />{!! $ticket_link !!}<br /><br />Thanks<br />{!! $system_from !!}<br />', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'org-mngr-templates'),
(50, 'template-ticket-assignment-notice-to-org-mngr', '0', 1, '', 'Hello {!! $receiver_name !!},<br /><br />Your organization member\'s ticket with ID: {!! $ticket_number !!} has been assigned to one of our agents. They will contact them soon.<br /><br /><br />Kind Regards,<br />{!! $system_from !!}</p>', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'org-mngr-templates'),
(51, 'ticket-approval', '1', 34, 'Ticket Approval Link', '<p>Hello {!! $receiver_name !!},<br /><br />Ticket <a href=\"{!! $ticket_link !!}\">{!! $ticket_number !!}</a> has been waiting for your approval.<br /><br />Please click here to review the ticket : {!! $approval_link !!} .<br /><br />Have a nice day.<br /><br />Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'agent-templates'),
(52, 'template-register-confirmation-with-account-details-and-activation', '1', 35, 'Registration confirmed, account verifcation required', 'Hello {!! $receiver_name !!},<br /><br />This email is confirmation that you are now registered at our helpdesk.<br /><br /><strong>Registered Email:</strong> {!! $new_user_email !!}<br /><strong>Password:</strong> {!! $user_password !!}<br /><br />Please click on the below link to activate your account and Login to the system<br/>{!! $account_activation_link !!}<br/><br/>You can visit the helpdesk to browse articles and contact us at any time: {!! $system_link !!}<br />Thank You.<br /><br />Kind Regards,<br />{!! $system_from !!}', '', 1, '2018-11-07 01:02:01', '2018-11-07 01:02:01', 'common-tmeplates');
...
(31, 'rating', '2018-04-17 17:26:39', '2018-04-17 17:26:39'),
(32, 'rating-confirmation', '2018-04-17 17:26:39', '2018-04-17 17:26:39'),
(33, 'report-export', '2018-07-18 23:48:16', '2018-07-18 23:48:16'),
(34, 'ticket-approval', '2018-07-18 18:18:16', '2018-07-18 18:18:16'),
...
INSERT INTO `tickets` (`id`, `ticket_number`, `user_id`, `dept_id`, `team_id`, `priority_id`, `sla`, `help_topic_id`, `status`, `rating`, `ratingreply`, `flags`, `ip_address`, `assigned_to`, `lock_by`, `lock_at`, `source`, `isoverdue`, `reopened`, `isanswered`, `html`, `is_deleted`, `closed`, `is_transferred`, `transferred_at`, `reopened_at`, `duedate`, `closed_at`, `last_message_at`, `first_response_time`, `approval`, `follow_up`, `created_at`, `updated_at`, `resolution_time`, `is_response_sla`, `is_resolution_sla`, `type`, `last_estd_duedate`) VALUES
(1, 'AAAA-0000-0000', 11, 1, NULL, 1, 1, 1, 2, 0, 0, 0, 0, 2, 0, NULL, 1, 0, 0, 1, 0, 0, 1, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 14:05:41', '2017-03-30 04:54:50', NULL, '2017-03-30 04:28:39', 0, 0, '2017-03-29 22:35:41', '2017-03-29 23:24:50', '50', 1, 1, 1, NULL),
(2, 'AAAA-0000-0001', 18, 1, NULL, 1, 1, 1, 3, 0, 0, 0, 0, 1, 0, NULL, 1, 0, 0, 1, 0, 0, 1, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 14:58:59', '2017-03-30 05:03:34', NULL, '2017-03-30 05:00:51', 0, 0, '2017-03-29 23:28:59', '2017-03-29 23:33:35', '5', 1, 1, 1, NULL),
(3, 'AAAA-0000-0002', 19, 2, NULL, 1, 1, 2, 1, 0, 0, 0, 0, 1, 0, NULL, 1, 0, 0, 1, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 15:05:17', NULL, NULL, '2017-03-30 05:07:19', 0, 0, '2017-03-29 23:35:17', '2017-03-29 23:37:20', NULL, 1, 0, 1, NULL),
(4, 'AAAA-0000-0003', 15, 3, NULL, 1, 1, 3, 1, 0, 0, 0, 0, NULL, 0, NULL, 1, 0, 0, 0, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 10:10:29', NULL, NULL, NULL, 0, 0, '2017-03-29 23:40:29', '2017-03-29 23:40:29', NULL, 0, 0, 1, NULL),
(5, 'AAAA-0000-0004', 16, 2, NULL, 1, 1, 2, 2, 0, 0, 0, 0, 4, 0, NULL, 1, 0, 0, 1, 0, 0, 1, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 15:12:59', '2017-03-30 05:15:53', NULL, '2017-03-30 05:15:27', 0, 0, '2017-03-29 23:42:59', '2017-03-29 23:45:53', '3', 1, 1, 1, NULL),
(6, 'AAAA-0000-0005', 16, 2, NULL, 1, 1, 1, 1, 0, 0, 0, 0, NULL, 0, NULL, 1, 0, 0, 0, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 10:19:12', NULL, NULL, NULL, 0, 0, '2017-03-29 23:49:12', '2017-03-29 23:49:12', NULL, 0, 0, 1, NULL),
(7, 'AAAA-0000-0006', 10, 1, NULL, 1, 1, 1, 7, 0, 0, 0, 0, 5, 0, NULL, 1, 0, 0, 1, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 15:21:20', NULL, NULL, '2017-03-30 05:23:41', 0, 0, '2017-03-29 23:51:20', '2017-03-29 23:54:06', NULL, 1, 0, 1, NULL),
(8, 'AAAA-0000-0007', 20, 1, NULL, 1, 1, 1, 1, 0, 0, 0, 0, 1, 0, NULL, 1, 0, 0, 1, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 15:25:07', NULL, NULL, '2017-03-30 05:28:04', 0, 0, '2017-03-29 23:55:07', '2017-03-29 23:58:05', NULL, 1, 0, 1, NULL),
(14, 'AAAA-0000-0010', 16, 2, NULL, 1, 1, 2, 1, 0, 0, 0, 0, 4, 0, NULL, 1, 0, 0, 1, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 15:53:35', NULL, NULL, '2017-03-30 05:58:46', 0, 0, '2017-03-30 00:23:35', '2017-03-30 00:28:52', NULL, 1, 0, 1, NULL),
(10, 'AAAA-0000-0008', 23, 2, NULL, 1, 1, 2, 1, 0, 0, 0, 0, 1, 0, NULL, 1, 0, 0, 1, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 15:36:31', NULL, NULL, '2017-03-30 05:39:18', 0, 0, '2017-03-30 00:06:31', '2017-03-30 00:09:18', NULL, 1, 0, 1, NULL),
(13, 'AAAA-0000-0009', 12, 1, NULL, 1, 1, 1, 1, 0, 0, 0, 0, 1, 0, NULL, 1, 0, 0, 1, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 15:48:34', NULL, NULL, '2017-03-30 05:50:15', 0, 0, '2017-03-30 00:18:34', '2017-03-30 00:20:48', NULL, 1, 0, 1, NULL),
(15, 'AAAA-0000-0011', 16, 2, NULL, 1, 1, 1, 1, 0, 0, 0, 0, NULL, 0, NULL, 1, 0, 0, 0, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 11:00:20', NULL, NULL, NULL, 0, 0, '2017-03-30 00:30:20', '2017-03-30 00:30:20', NULL, 0, 0, 1, NULL),
(16, 'AAAA-0000-0012', 16, 1, NULL, 1, 1, 1, 1, 0, 0, 0, 0, 1, 0, NULL, 1, 0, 0, 1, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 16:01:45', NULL, NULL, '2017-03-30 06:03:34', 0, 0, '2017-03-30 00:31:45', '2017-03-30 00:33:34', NULL, 1, 0, 1, NULL),
(17, 'AAAA-0000-0013', 17, 1, NULL, 1, 1, 1, 2, 0, 0, 0, 0, 6, 0, NULL, 1, 0, 0, 1, 0, 0, 1, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 16:04:51', '2017-03-30 06:06:55', NULL, '2017-03-30 06:06:38', 0, 0, '2017-03-30 00:34:51', '2017-03-30 00:36:55', '3', 1, 1, 1, NULL),
(18, 'AAAA-0000-0014', 11, 2, NULL, 1, 1, 2, 3, 0, 0, 0, 0, 2, 0, NULL, 1, 0, 0, 1, 0, 0, 1, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 16:10:16', '2017-03-30 06:12:29', NULL, '2017-03-30 06:12:15', 0, 0, '2017-03-30 00:40:16', '2017-03-30 00:42:29', '3', 1, 1, 1, NULL),
(19, 'AAAA-0000-0015', 11, 1, NULL, 1, 1, 1, 1, 0, 0, 0, 0, 2, 0, NULL, 1, 0, 0, 1, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 16:13:36', NULL, NULL, '2017-03-30 06:15:20', 0, 0, '2017-03-30 00:43:36', '2017-03-30 00:45:25', NULL, 1, 0, 1, NULL),
(20, 'AAAA-0000-0016', 11, 1, NULL, 1, 1, 1, 1, 0, 0, 0, 0, NULL, 0, NULL, 1, 0, 0, 0, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 11:16:02', NULL, NULL, NULL, 0, 0, '2017-03-30 00:46:02', '2017-03-30 00:46:03', NULL, 0, 0, 1, NULL),
(21, 'AAAA-0000-0017', 18, 3, NULL, 1, 1, 3, 1, 0, 0, 0, 0, NULL, 0, NULL, 1, 0, 0, 0, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 11:19:18', NULL, NULL, NULL, 0, 0, '2017-03-30 00:49:18', '2017-03-30 00:49:18', NULL, 0, 0, 1, NULL),
(22, 'AAAA-0000-0018', 18, 3, NULL, 1, 1, 3, 3, 0, 0, 0, 0, 8, 0, NULL, 1, 0, 0, 1, 0, 0, 1, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 16:22:12', '2017-03-30 06:23:29', NULL, '2017-03-30 06:23:03', 0, 0, '2017-03-30 00:52:12', '2017-03-30 00:53:29', '2', 1, 1, 1, NULL),
(23, 'AAAA-0000-0019', 19, 1, NULL, 1, 1, 1, 7, 0, 0, 0, 0, 2, 0, NULL, 1, 0, 0, 1, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 16:24:30', NULL, NULL, '2017-03-30 06:26:14', 0, 0, '2017-03-30 00:54:30', '2017-03-30 00:56:30', NULL, 1, 0, 1, NULL),
(24, 'AAAA-0000-0020', 19, 1, NULL, 1, 1, 1, 1, 0, 0, 0, 0, NULL, 0, NULL, 1, 0, 0, 0, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 11:27:29', NULL, NULL, NULL, 0, 0, '2017-03-30 00:57:29', '2017-03-30 00:57:29', NULL, 0, 0, 1, NULL),
(25, 'AAAA-0000-0021', 10, 3, NULL, 1, 1, 3, 5, 0, 0, 0, 0, 5, 0, NULL, 1, 0, 0, 1, 0, 1, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 16:29:04', NULL, NULL, '2017-03-30 06:30:31', 0, 0, '2017-03-30 00:59:04', '2017-03-30 01:00:47', NULL, 1, 0, 1, NULL),
(26, 'AAAA-0000-0022', 10, 1, NULL, 1, 1, 1, 1, 0, 0, 0, 0, NULL, 0, NULL, 1, 0, 0, 0, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 11:32:30', NULL, NULL, NULL, 0, 0, '2017-03-30 01:02:30', '2017-03-30 01:02:30', NULL, 0, 0, 1, NULL),
(27, 'AAAA-0000-0023', 23, 1, NULL, 1, 1, 1, 1, 0, 0, 0, 0, 5, 0, NULL, 1, 0, 0, 1, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 16:34:50', NULL, NULL, '2017-03-30 06:35:56', 0, 0, '2017-03-30 01:04:50', '2017-03-30 01:06:02', NULL, 1, 0, 1, NULL),
(28, 'AAAA-0000-0024', 20, 3, NULL, 1, 1, 1, 1, 0, 0, 0, 0, 1, 0, NULL, 1, 0, 0, 1, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 16:39:06', NULL, NULL, '2017-03-30 06:39:46', 0, 0, '2017-03-30 01:09:06', '2017-03-30 01:09:46', NULL, 1, 0, 1, NULL),
(29, 'AAAA-0000-0025', 9, 1, NULL, 2, 2, 1, 1, 0, 0, 0, 0, 7, 0, NULL, 1, 0, 0, 0, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 11:41:16', NULL, NULL, NULL, 0, 0, '2017-03-30 01:11:16', '2017-10-04 05:47:32', NULL, 0, 0, 1, NULL),
(30, 'AAAA-0000-0026', 9, 1, NULL, 1, 1, 1, 1, 0, 0, 0, 0, 1, 0, NULL, 1, 0, 0, 1, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 16:43:48', NULL, NULL, '2017-03-30 06:44:30', 0, 0, '2017-03-30 01:13:48', '2017-03-30 01:14:31', NULL, 1, 0, 1, NULL),
(31, 'AAAA-0000-0027', 14, 3, NULL, 1, 1, 3, 1, 0, 0, 0, 0, NULL, 0, NULL, 1, 0, 0, 0, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 11:45:34', NULL, NULL, NULL, 0, 0, '2017-03-30 01:15:34', '2017-03-30 01:15:34', NULL, 0, 0, 1, NULL),
(32, 'AAAA-0000-0028', 14, 1, NULL, 1, 1, 1, 3, 0, 0, 0, 0, 1, 0, NULL, 1, 0, 0, 1, 0, 0, 1, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 16:46:20', '2017-03-30 06:47:09', NULL, '2017-03-30 06:46:54', 0, 0, '2017-03-30 01:16:20', '2017-03-30 01:17:09', '1', 1, 1, 1, NULL),
(33, 'AAAA-0000-0029', 21, 1, NULL, 1, 1, 1, 1, 0, 0, 0, 0, 1, 0, NULL, 1, 0, 0, 1, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 16:48:01', NULL, NULL, '2017-03-30 06:48:20', 0, 0, '2017-03-30 01:18:01', '2017-03-30 01:18:21', NULL, 1, 0, 1, NULL),
(34, 'AAAA-0000-0030', 21, 2, NULL, 1, 1, 2, 3, 0, 0, 0, 0, 1, 0, NULL, 1, 0, 0, 1, 0, 0, 1, 0, '0000-00-00 00:00:00', NULL, '2017-03-30 16:49:16', '2017-03-30 06:50:14', NULL, '2017-03-30 06:49:53', 0, 0, '2017-03-30 01:19:16', '2017-03-30 01:20:14', '1', 1, 1, 1, NULL),
(35, 'AAAA-0000-0031', 24, 1, NULL, 1, 1, 1, 1, 0, 0, 0, 0, NULL, 0, NULL, 2, 0, 0, 0, 0, 0, 0, 0, '0000-00-00 00:00:00', NULL, '2017-08-31 12:20:13', NULL, NULL, NULL, 0, 0, '2017-08-31 05:20:13', '2017-08-31 05:20:13', NULL, 0, 0, 0, NULL);
...
CREATE TABLE IF NOT EXISTS `ticket_filter_meta` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ticket_filter_shareables` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `ticket_filter_id` int(10) UNSIGNED NOT NULL,
...
(8, 'Unapproved', 'Ticket have been marked as Unapproved by {!!$user!!}', '2018-03-28 08:56:08', '2018-03-28 08:56:08', 0, 0, 1, 7, NULL, '{\"client\":\"0\",\"admin\":\"1\",\"assigned_agent_team\":\"0\"}', 0, 7, 'fa fa-clock-o', '#f20630', 1);
...
(25, 'America/Godthab', '(GMT-03:00) Greenland'),
...
CREATE TABLE IF NOT EXISTS `user_assign_organization` (
  ...
  `user_id` int(10) UNSIGNED DEFAULT NULL,
  `role` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `org_department` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `org_id` (`org_id`),
...
CREATE TABLE IF NOT EXISTS `workflow_name` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `rule_match` varchar(10) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'all',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
