...
const fa = {
    btn: {
        ...
        clearSelect: 'پاک کردن تمام فایل‌های انتخاب شده',
    ...
    clearall:{
        clear_all_selection : 'تمام انتخاب ها را پاک کنید',
        delete_all : 'آیا واقعاً می خواهید همه فایل های انتخاب شده را پاک کنید؟',
    }
};
