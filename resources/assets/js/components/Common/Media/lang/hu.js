...
const hu = {
    btn: {
        ...
        clearSelect: "Összes kiválasztott fájl törlése",
    ...
    clearall:{
        clear_all_selection : 'Az összes kijelölés törlése',
        delete_all : 'Biztosan törölni szeretné az összes kiválasztott fájlt?',
    }
};
