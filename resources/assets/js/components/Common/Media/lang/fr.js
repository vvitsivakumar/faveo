...
const fr = {
    btn: {
        ...
        clearSelect: 'Effacer tous les fichiers sélectionnés',
    ...
    clearall:{
        clear_all_selection : 'Effacer toute la sélection',
        delete_all : 'Voulez-vous vraiment effacer tous les fichiers sélectionnés ?',
    }
};
