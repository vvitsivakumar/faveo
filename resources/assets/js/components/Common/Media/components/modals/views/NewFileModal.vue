<template>
	<div class="modal-content fm-modal-folder">
		<div class="modal-header">
			<h5 class="modal-title">{{ lang1.modal.newFile.title }}</h5>
		...
		<div class="modal-body">
			<div class="form-group">
				<label for="fm-file-name">{{ lang1.modal.newFile.fieldName }}</label>
				...
				<div class="invalid-feedback" v-show="fileExist">
					{{ lang1.modal.newFile.fieldFeedback }}
				</div>
			</div>
		</div>
		<div class="modal-footer">
			<button class="btn btn-info"
					...
					v-on:click="addFile">{{ lang1.btn.submit }}
			</button>
