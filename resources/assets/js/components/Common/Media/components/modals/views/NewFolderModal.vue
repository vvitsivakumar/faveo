<template>
	<div class="modal-content fm-modal-folder">
		<div class="modal-header">
			<h5 class="modal-title">{{ lang1.modal.newFolder.title }}</h5>
		...
		<div class="modal-body">
			<div class="form-group">
				<label for="fm-folder-name">{{ lang1.modal.newFolder.fieldName }}</label>
				...
				<div class="invalid-feedback" v-show="directoryExist">
					{{ lang1.modal.newFolder.fieldFeedback }}
				</div>
			</div>
		</div>
		<div class="modal-footer">
			<button class="btn btn-info"
					...
					v-on:click="addFolder">{{ lang1.btn.submit }}
			</button>
