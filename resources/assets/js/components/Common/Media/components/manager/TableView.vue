<template>
	<div class="fm-table">
		<table class="table table-sm">
			...
			<!--                    </td>-->
			<!--                    <td/>-->
			<!--                    <td>{{ lang1.manager.table.folder }}</td>-->
			<!--                    <td>-->
			...
			<tr v-for="(file, index) in files"
				...
				v-on:click="selectItem('files', file.path, $event, fromPage === 'widget')"
