<template>
  <div class="col-sm-12">
    ...
    <alert componentName="SocketDriverRedis"/>
        ...
        <template v-if="hasDataPopulated && !loading">
          ...
          <div class="row" v-focus-first-input>
            ...
            <text-field :label="trans('connection')"  name="connection" :value="connection"
                        classname="col-sm-6" :onChange="onChange" :required="true" placehold="default" :hint="trans('redis_info')">
...
export default {
  ...
  methods : {
    ...
    getData() {
      ...
      axios.get('api/get/socket-driver/redis').then(res => {
        ...
        errorHandler(err,'SocketDriverRedis');
      });
    },
    ...
    onSubmit() {
      ...
      if(this.isValid()){
        ...
        axios.post('api/post/socket-driver',{
          ...
          successHandler(res,'SocketDriverRedis');
