<template>
	...
	<div id="team-tickets-table">
		
		<div class="row">
			
			<div class="col-md-12">
				
				<alert componentName="TeamTickets"/>
			</div>
		</div>
						...
						<div class="active tab-pane" id="activity">
							...
							<div class="mt-3">
								...
								<div id="my_tic">
									...
									<team-tickets-table :category="category" :id="id" :tickets="ticketsData" :key="category"
                                      :isCalledFromAdmin="true" :apiUrl="apiUrl" :componentTitle="componentTitle"
                                      scroll_to="team-tickets-table" from="team" :disableLoader="disableLoader" @loaderValue="handelLoader" :allTickets="allData" >
	...
	export default {
      ...
      handelLoader(loader){
		...
		components : {
			...
			'team-tickets-table' : TicketsTable,
