...
$displaySidebar = ($itilSettings && $itilSettings == 1) ? 'active' : 'inactive' ;

?>
@section('sidebar') @if(!isPlugin('ServiceDesk') && $displaySidebar == 'inactive')
                                ...
                                <i class="fa fa-angle-left pull-right"></i>
                                    ...
                                    <ul class="treeview-menu">
                                        <li @yield('add-article')><a href="{{url('article/create')}}"><i class="fa fa-circle-o"></i> {{Lang::get('lang.addarticle')}}</a></li>
                                         ...
                                         <li @yield('add-article-template')><a href="{{url('article/create/template')}}"><i class="fa fa-circle-o"></i> {{Lang::get('lang.addarticletemplate')}}</a></li>

                                         <li @yield('all-article-template')><a href="{{url('article/alltemplate/list')}}"><i class="fa fa-circle-o"></i> {{Lang::get('lang.allarticletemplate')}}</a></li>
                                     </ul>
                        </li>
